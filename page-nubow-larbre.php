...
<main id="page" class="shop-info">
	...
	<div class="main-content">
		<ul class="tab-menu">
			...
			<li class="tab is-active"><a href="<?php echo home_url('/'); ?>shop/nubow-larbre">ヌボーラルブル</a></li>
		</ul>
				...
				<div class="honten">
					...
					<div class="shop-image-wrap">
						...
						<div class="shop-logo-wrap">
							<img src="<?php echo get_template_directory_uri(); ?>/img/page/shop-info_shop-list_img03.png" alt="ヌボーラルブル ロゴ" class="shop-logo">
						</div>
					</div>
					...
					<div class="box">
						<h4>ヌボーラルブルについて</h4>
						<p>
							ラルブルはフランス語で“樹”の意味。沢山の緑に囲まれて、時々陽の光がキラキラ差し込む。まるで“樹”の木陰の下に来たかのような。そこで少し休憩すると、何だか心も身体も休まる。お客様にとって、そんなお店でありたい、そんな想いが込められて店舗です。
						</p>
					</div>
					...
					<div class="box">
						...
						<div class="map">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3201.273325225061!2d138.18610711159323!3d36.643874676380165!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x601d8692974208ed%3A0xea600b65e331a45!2z44OM44Oc44O844Op44Or44OW44Or!5e0!3m2!1sja!2sjp!4v1755664308348!5m2!1sja!2sjp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
						</div>
					</div>
