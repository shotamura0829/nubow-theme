<?php
/*
Template Name: About Us - New Greeting
*/
get_header();
?>
			...
			<div class="tab-contents">
				<div class="greeting">
					...
					<div class="box">
						...
						<img src="<?php echo get_template_directory_uri(); ?>/img/page/about_greeting_img01.jpg" alt="">
					</div>
					...
					<!-- 代表プロフィール・活動セクション -->
					<div class="greeting-extra">
						<div class="profile-activity-wrap">
							<section class="profile-section">
								<h3>代表プロフィール</h3>
								<p class="profile-name">代表取締役　山﨑 年起（Toshiki Yamasaki）</p>
								...
								<p class="sns-link">
									<strong>SNS</strong>
									<a href="https://www.instagram.com/nubow.tyamazaki/" target="_blank" rel="noopener noreferrer" class="instagram-link" aria-label="Instagram">Instagram</a>
									nubow.tyamazaki（日々の活動や経営の裏側を発信中）
								</p>
							</section>
							<section class="activity-section">
								...
								<div class="activity-logo">
									<!-- はなやのミカタロゴ挿入箇所：img/page/hanayano-mikata-logo.png などを配置後、altを設定してください -->
