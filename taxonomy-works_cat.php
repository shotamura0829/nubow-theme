				...
				<div class="service-radio-list">
					...
					if (!empty($case_terms) && !is_wp_error($case_terms)) :
						foreach ($case_terms as $index => $case_term) :
							$input_id = 'works_category_' . $index;
							?>
							<input class="visually-hidden" type="radio" name="works_category" id="<?php echo esc_attr($input_id); ?>" value="<?php echo esc_attr($case_term->slug); ?>">
